...
if(EXISTS "${CMAKE_SOURCE_DIR}/3rdparty/yaml-cpp/yaml-cpp/CMakeLists.txt")
    message(STATUS "yaml-cpp has not had a release in over a year at the time of writing despite many bug fixes and improvements.  PCSX2 vendors the master branch instead to consume these.")
    add_subdirectory(3rdparty/yaml-cpp/yaml-cpp EXCLUDE_FROM_ALL)
    else()
    message(FATAL_ERROR "yaml-cpp directory was not found")
endif()
